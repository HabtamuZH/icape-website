...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen text-white text-left flex justify-start  mt-8 items-center lg:px-0 px-8 md:px-16 overflow-hidden">
      {/* Hero Image */}
      <div
      ...
      <div className="relative w-full md:w-[54%] ml-0 md:ml-24 z-10 text-left">
        <h1 className="font-manrope font-semibold text-[2rem] md:text-[2.8rem] leading-tight md:leading-snug">
          You are one step closer to become Partner with us and grow your
