        ...
        <div className='bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-lg overflow-hidden'>
          <div className='relative h-48'>
            ...
            <div className='absolute top-4 right-4'>
              <label className='bg-white bg-opacity-20 hover:bg-opacity-30 text-white text-sm font-semibold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105 cursor-pointer'>
