...
const overviewContent = [
  {
    ...
    description:
      "Our Architectural Design service is the cornerstone of our practice, where creativity meets technical mastery. We design buildings that tell a story—whether through bold modern lines or classical elegance—tailored to the client’s aspirations and the site’s unique character. This process involves detailed planning, 3D modeling, and iterative refinement, ensuring that each structure is a harmonious blend of beauty, practicality, and durability, destined to leave a lasting legacy.",
  },
];
