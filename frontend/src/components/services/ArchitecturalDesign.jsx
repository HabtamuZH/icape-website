...
const ArchitecturalDesign = () => {
  useEffect(() => {
    ...
    sr.reveal(".sectionHeader", {
      origin: "top",
      distance: "50px",
      delay: 100,
    });
    sr.reveal(".contentText", {
      origin: "bottom",
      distance: "50px",
      delay: 200,
    });
    sr.reveal(".readMoreButton", {
      origin: "bottom",
      distance: "30px",
      delay: 300,
    });
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 flex flex-col items-center justify-center min-h-screen">
        ...
        <p className="contentText text-light/80 text-base sm:text-lg lg:text-xl font-body max-w-3xl text-center mb-10 leading-relaxed">
          We craft architectural masterpieces that seamlessly blend creativity,
          sustainability, and functionality—designing spaces that inspire,
          endure, and elevate everyday living.
        </p>
        <Link
