...
import FormHeader from "../internApplications/FormHeader";
import FormField from "../internApplications/FormField";
      ...
      <div className="container-custom">
        ...
        >
            <div className="bg-secondary-light/80 dark:bg-dark-surface/80 backdrop-blur-xl p-8 md:p-12 rounded-[2.5rem] border border-border dark:border-dark-border shadow-2xl">
              <FormHeader
                title="Join our Team"
                description="Apply for our Professional Career Opportunities and contribute to world-class architecture."
              />
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <FormField
                  ...
                  onChange={handleChange}
                  placeholder="List your skills and professional experience..."
                  required
                />
